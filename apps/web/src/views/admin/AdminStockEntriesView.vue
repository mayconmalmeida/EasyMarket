...
<template>
  <div class="space-y-4">
    ...
    <div class="rounded-2xl border border-[#E5E7EB] bg-white p-4 shadow-sm">
      ...
      <DataTable :value="entriesStore.items" dataKey="id" paginator :rows="10" :rowsPerPageOptions="[10, 20, 50]" stripedRows showGridlines>
        ...
        <Column field="note" header="Obs." style="min-width: 16rem" />
        <template #empty>
